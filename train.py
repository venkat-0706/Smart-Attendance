...
# Secret key for sessions (must be long and random for security)
app.secret_key = os.urandom(24)  # This generates a secure random key every time
...
# Make /home redirect to /dashboard
@app.route('/home')
def home_redirect():
